...
//             <input type="text" id='phonenumber'  className='h-8 rounded-sm  outline-yellow-500 border-2 border-gray-300 pl-1'/>
//         </div>
...
//               <input type="password" id='Password' className='h-8 rounded-sm outline-yellow-500  border-2 border-gray-300 pl-1'/>
//         </div>
...
//         <div  className='w-full bg-gray-200 text-center p-2 mt-4 rounded-md border-gray-300'><button  onSubmit={handlenewaccount}>create New Account</button></div>
//         <br/>
  ...
  return (
    <div className='w-screen h-screen flex justify-center p-5'>
      ...
      <div className=' w-full h-auto p-5 border-2 border-gray-200 mt-8 '>
        ...
        <div className='flex flex-col pt-2 text-md'>
            <label htmlFor="phonenumber">Email or mobile number</label>
            <input type="text" id='phonenumber'  className='h-8 rounded-sm  outline-yellow-500 border-2 border-gray-300 pl-1' required/>
        </div>
        <div className='flex flex-col pt-2'>
              <div className='flex justify-between'><label htmlFor="phonenumber">Password</label> <button className='text-blue-500'>Forgot your password?</button></div>
              <input type="password" id='Password' className='h-8 rounded-sm outline-yellow-500  border-2 border-gray-300 pl-1' required />
        </div>
        <div className='w-full bg-yellow-500 text-center p-2 mt-4 rounded-md'><button onClick={handlesignIn}>Sign In</button></div>
        <br />
        <div className='text-center'>⎯⎯⎯⎯ New to Amazon? ⎯⎯⎯⎯</div>
